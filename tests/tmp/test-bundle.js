...
require.define("/node/rsvp.js",function(require,module,exports,__dirname,__filename,process,global){"use strict";
var config = {};
...
//It needs a few sshim first though.
var slice = [].slice;
var _ = {};

//This is from Underscore.js 1.4.3
...
//The only modification of the code below was to remove Backbone.Events = in the line
//defining the Events object.
/* This is copied from Backbone 0.9.9. */
  // Backbone.Events
  // ---------------
...
var Promise = function() {
  this.future = new Future(promise);
};
...
function reject(promise, value) {
  config.async(function() {
    promise.trigger('promise:rejected', value);
  });
};
...
//Making a clearer way to attach handlers, after jQuery Deferred methods.
Future.prototype.done = function(done) {
  return this.then(done, undefined);
};
...
//flatMap interface
Future.prototype.flatMap = function(fn, context) {
  return this.then(fn.bind(context));
};
Future.prototype.map = function(fn, context) {
  return this.flatMap(function(value) {
    return new Promise(fn.call(context, value));
  });
};


//Twitter Future style
Future.collect = all;
...
// //Returns when the first promise finishes (either success or failure).
// //It yields a tuple of [value, otherPromises].
...
//   var resolve = function(index, value) {
//     var otherPromises = promises.slice(0, index).concat(promises.slice(index + 1));
//     firstPromise.resolve([value, otherPromises]);
//   };
...
//   return firstPromise;
// };
// Promise.prototype.select = first;
// Promise.prototype.first = first;
...
require.define("/promises-tests/lib/tests/helpers/testThreeCases.js",function(require,module,exports,__dirname,__filename,process,global){"use strict";
...
require.define("/promises-tests/node_modules/sinon/package.json",function(require,module,exports,__dirname,__filename,process,global){module.exports = {"main":"./lib/sinon.js"}
});

require.define("/promises-tests/node_modules/sinon/lib/sinon.js",function(require,module,exports,__dirname,__filename,process,global){/*jslint eqeqeq: false, onevar: false, forin: true, nomen: false, regexp: false, plusplus: false*/
...
require.define("/promises-tests/node_modules/sinon/node_modules/buster-format/package.json",function(require,module,exports,__dirname,__filename,process,global){module.exports = {"main":"./lib/buster-format"}
});

require.define("/promises-tests/node_modules/sinon/node_modules/buster-format/lib/buster-format.js",function(require,module,exports,__dirname,__filename,process,global){if (typeof buster === "undefined") {
    var buster = {};
}
...
require.define("/promises-tests/node_modules/sinon/node_modules/buster-format/node_modules/buster-core/package.json",function(require,module,exports,__dirname,__filename,process,global){module.exports = {"main":"./lib/buster-core"}
});

require.define("/promises-tests/node_modules/sinon/node_modules/buster-format/node_modules/buster-core/lib/buster-core.js",function(require,module,exports,__dirname,__filename,process,global){var buster = (function (setTimeout, B) {
...
require.define("/promises-tests/node_modules/sinon/node_modules/buster-format/node_modules/buster-core/lib/buster-event-emitter.js",function(require,module,exports,__dirname,__filename,process,global){/*jslint eqeqeq: false, onevar: false, plusplus: false*/
...
require.define("/promises-tests/node_modules/sinon/node_modules/buster-format/node_modules/buster-core/lib/define-version-getter.js",function(require,module,exports,__dirname,__filename,process,global){var path = require("path");
var fs = require("fs");
...
require.define("/promises-tests/node_modules/sinon/lib/sinon/stub.js",function(require,module,exports,__dirname,__filename,process,global){/**
 * @depend ../sinon.js
 * @depend spy.js
 */
...
require.define("/promises-tests/node_modules/sinon/lib/sinon/mock.js",function(require,module,exports,__dirname,__filename,process,global){/**
 * @depend ../sinon.js
 * @depend stub.js
 */
...
require.define("/promises-tests/node_modules/sinon/lib/sinon/collection.js",function(require,module,exports,__dirname,__filename,process,global){/**
 * @depend ../sinon.js
 * @depend stub.js
 * @depend mock.js
 */
...
require.define("/promises-tests/node_modules/sinon/lib/sinon/assert.js",function(require,module,exports,__dirname,__filename,process,global){/**
 * @depend ../sinon.js
 * @depend stub.js
 */
...
require.define("/promises-tests/node_modules/sinon/lib/sinon/sandbox.js",function(require,module,exports,__dirname,__filename,process,global){/**
 * @depend ../sinon.js
...
require.define("/promises-tests/node_modules/sinon/lib/sinon/util/fake_timers.js",function(require,module,exports,__dirname,__filename,process,global){/*jslint eqeqeq: false, plusplus: false, evil: true, onevar: false, browser: true, forin: false*/
...
require.define("/promises-tests/node_modules/sinon/lib/sinon/test.js",function(require,module,exports,__dirname,__filename,process,global){/**
 * @depend ../sinon.js
 * @depend stub.js
 * @depend mock.js
 * @depend sandbox.js
...
require.define("/promises-tests/node_modules/sinon/lib/sinon/test_case.js",function(require,module,exports,__dirname,__filename,process,global){/**
 * @depend ../sinon.js
 * @depend test.js
 */
...
require.define("/promises-tests/node_modules/sinon/lib/sinon/match.js",function(require,module,exports,__dirname,__filename,process,global){/* @depend ../sinon.js */
/*jslint eqeqeq: false, onevar: false, plusplus: false*/
/*global module, require, sinon*/
/**
 * Match functions
...
require.define("/tests/test-adapter.js",function(require,module,exports,__dirname,__filename,process,global){/*global RSVP*/
...
require("/tests/test-adapter.js");

require.define("/promises-tests/lib/tests/3.2.1.js",function(require,module,exports,__dirname,__filename,process,global){"use strict";
...
require("/promises-tests/lib/tests/3.2.1.js");

require.define("/promises-tests/lib/tests/3.2.2.js",function(require,module,exports,__dirname,__filename,process,global){"use strict";
...
require("/promises-tests/lib/tests/3.2.2.js");

require.define("/promises-tests/lib/tests/3.2.3.js",function(require,module,exports,__dirname,__filename,process,global){"use strict";
...
require("/promises-tests/lib/tests/3.2.3.js");

require.define("/promises-tests/lib/tests/3.2.4.js",function(require,module,exports,__dirname,__filename,process,global){"use strict";
...
require("/promises-tests/lib/tests/3.2.4.js");

require.define("/promises-tests/lib/tests/3.2.5.js",function(require,module,exports,__dirname,__filename,process,global){"use strict";
...
require("/promises-tests/lib/tests/3.2.5.js");

require.define("/promises-tests/lib/tests/3.2.6.js",function(require,module,exports,__dirname,__filename,process,global){"use strict";
...
require("/promises-tests/lib/tests/3.2.6.js");
...
require("/promises-tests/lib/tests/helpers/testThreeCases.js");
...
require("/promises-tests/node_modules/sinon/lib/sinon.js");
...
require("/promises-tests/node_modules/sinon/lib/sinon/assert.js");
...
require("/promises-tests/node_modules/sinon/lib/sinon/collection.js");
...
require("/promises-tests/node_modules/sinon/lib/sinon/match.js");
...
require("/promises-tests/node_modules/sinon/lib/sinon/mock.js");
...
require("/promises-tests/node_modules/sinon/lib/sinon/spy.js");
...
require("/promises-tests/node_modules/sinon/lib/sinon/stub.js");
...
require("/promises-tests/node_modules/sinon/lib/sinon/test.js");
...
require("/promises-tests/node_modules/sinon/lib/sinon/test_case.js");
})();
